...
def run_module(module_path: Path, input_path: Path, outdir: Path, schema_path: Path) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    {"name": _ucc_name, "metrics": context["metrics"]}
        ...
        emit_tel_event(
            ...
            "ucc_run_module_metrics",

            {"name": _ucc_name, "metrics": context.get("metrics", {})},
        ...
        emit_tel_event("ucc_run_module_end", {"name": _ucc_name, "ok": _ucc_ok, "metrics": context.get("metrics", {})})
