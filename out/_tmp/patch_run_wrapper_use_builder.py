...
lines.append(i2 + "from konomi.tel.build import build_tel_for_out_dir")
lines.append("")
...
lines.append("")
lines.append(i2 + "_tel = build_tel_for_out_dir(_out_dir, _telemetry_data, max_depth=2)")
...
print("OK: run_wrapper TEL block now uses build_tel_for_out_dir")
